...
def getVoltage():
    ...
    ##########################################
    return inaVolt # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "SCUTTLE 03", font=font, fill=255)
    ...
    #################################################
    draw.text((0, 40), "Robot Voltage: " + str(inaVolt) + "V", font=font, fill=225)
